...
resource "zpa_application_server" "sales_internal" {
  name        = "sales-internal.securitygeek.io"
  description = "sales-internal.securitygeek.io"
  address     = "sales-internal.securitygeek.io"
  enabled     = true
}
